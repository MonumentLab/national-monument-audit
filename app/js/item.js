...
var Item = (function() {
  ...
  function Item(config) {
    var defaults = {
      ...
      'generatedFields': ['object_groups', 'object_group_reason', 'monument_types', 'entities_people', 'ethnicity_represented', 'gender_represented', 'entities_events', 'themes', 'geo_type', 'county_geoid']
    };
