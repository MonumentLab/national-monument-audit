...
var Map = (function() {
  ...
  function Map(config) {
    var defaults = {
      ...
      'returnFacets': ['object_groups', 'source', 'themes', 'monument_types', 'entities_people', 'entities_events', 'gender_represented', 'ethnicity_represented', 'state', 'year_dedicated_or_constructed', 'county_geoid'], // note if these are changed, you must also update the allowed API Gateway queryParams for facet.X and redeploy the API
      'facetLabels': {
